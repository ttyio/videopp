...
//
////////////////////////////////////////////////////////////////////////////
#ifndef NV_HW_ENCODER_H
#define NV_HW_ENCODER_H
...
public:
    ...
    NVENCSTATUS NvEncCreateInputBuffer(uint32_t width, uint32_t height, void** inputBuffer);
    ...
    NVENCSTATUS                                          CreateEncoder(const char* outputName, int codec, int width, int height, int fps, int bitrate);
